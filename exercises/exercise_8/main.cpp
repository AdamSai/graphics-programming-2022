...
int main()
{
    ...
    // ----------------------------------
    phong_shading = new Shader( "shaders/painting.vert", "shaders/phong_shading.frag" );
...
void drawGui()
{
...

    {
        ...
        {
            if ( ImGui::RadioButton( "Blinn-Phong Shading", shader == phong_shading ))
            { shader = phong_shading; }
            if ( ImGui::RadioButton( "PBR Shading", shader == pbr_shading ))
            { shader = pbr_shading; }
        }
