...
void main()
{
    ...
    vec3 contastedColor = clamp((color - vec3(0.5, 0.5, 0.5))* contrast + vec3(0.5, 0.5, 0.5), 0, 1);// subtract gray
    color += contastedColor;
    //    color *= contrast;
    //    color += vec3(0.5, 0.5, 0.5);
    //TODO 9.2 : Modify hue
    //TODO 9.2 : Modify saturation
    // color *= HSVToRGB(vec3(hue, saturation, contrast));
